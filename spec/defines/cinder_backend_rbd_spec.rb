  ...
  shared_examples 'cinder::backend::rbd' do
    ...
    context 'rbd backend volume driver' do
      it {
        ...
        is_expected.to contain_cinder_config("#{req_params[:volume_backend_name]}/image_upload_use_cinder_backend").with_value('<SERVICE DEFAULT>')
        is_expected.to contain_cinder_config("#{req_params[:volume_backend_name]}/image_upload_use_internal_tenant").with_value('<SERVICE DEFAULT>')
      ...
      context 'with parameters' do
        ...
        it {
          ...
          is_expected.to contain_cinder_config("#{req_params[:volume_backend_name]}/backend_host").with_value(params[:backend_host])
          is_expected.to contain_cinder_config("#{req_params[:volume_backend_name]}/backend_availability_zone").with_value(params[:backend_availability_zone])
          is_expected.to contain_cinder_config("#{req_params[:volume_backend_name]}/reserved_percentage").with_value(params[:reserved_percentage])
          is_expected.to contain_cinder_config("#{req_params[:volume_backend_name]}/max_over_subscription_ratio").with_value(params[:max_over_subscription_ratio])
          is_expected.to contain_cinder_config("#{req_params[:volume_backend_name]}/image_upload_use_cinder_backend").with_value(params[:image_upload_use_cinder_backend])
          is_expected.to contain_cinder_config("#{req_params[:volume_backend_name]}/image_upload_use_internal_tenant").with_value(params[:image_upload_use_internal_tenant])
