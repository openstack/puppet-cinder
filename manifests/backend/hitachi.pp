...
define cinder::backend::hitachi (
  ...
  cinder_config {
    ...
    "${volume_backend_name}/volume_driver":                value => 'cinder.volume.drivers.hitachi.hbas_fc.HBSDFCDriver';
    "${volume_backend_name}/hitachi_pool_id":                 value => $hitachi_pool_id;
    "${volume_backend_name}/hitachi_vol_pool_id":              value => $hitachi_vol_pool_id;
    "${volume_backend_name}/hitachi_vol_thin_pool_id":       value => $hitachi_vol_thin_pool_id;
    "${volume_backend_name}/hitachi_target_ports":           value => $hitachi_target_ports;
    "${volume_backend_name}/hitachi_default_copy_method":       value => $hitachi_default_copy_method;
    "${volume_backend_name}/hitachi_copy_speed":        value => $hitachi_copy_speed;
    "${volume_backend_name}/hitachi_copy_check_interval":      value => $hitachi_copy_check_interval;
    "${volume_backend_name}/hitachi_async_copy_check_interval":        value => $hitachi_async_copy_check_interval;
    "${volume_backend_name}/hitachi_horcm_user":                value => $hitachi_horcm_user;
    "${volume_backend_name}/hitachi_horcm_password":           value => $hitachi_horcm_password;
    "${volume_backend_name}/hitachi_horcm_numbers":               value => $hitachi_horcm_numbers;
    "${volume_backend_name}/hitachi_rminst_user":         value => $hitachi_rminst_user;
    "${volume_backend_name}/hitachi_rminst_password":    value => $hitachi_rminst_password;
    "${volume_backend_name}/hitachi_serial_number":     value => $hitachi_serial_number;
    "${volume_backend_name}/hitachi_unit_name":            value => $hitachi_unit_name;
    "${volume_backend_name}/hitachi_ldev_range": value => $hitachi_ldev_range;
    "${volume_backend_name}/hitachi_rminst_add_conf":        value => $hitachi_rminst_add_conf;
    "${volume_backend_name}/hitachi_horcm_add_conf":           value => $hitachi_horcm_add_conf;
    "${volume_backend_name}/hitachi_zoning_request":         value => $hitachi_zoning_request;
    "${volume_backend_name}/hitachi_group_request":       value => $hitachi_group_request;
    "${volume_backend_name}/hitachi_group_range":       value => $hitachi_group_range;
    "${volume_backend_name}/hitachi_add_chap_user":       value => $hitachi_add_chap_user;
    "${volume_backend_name}/hitachi_auth_method":       value => $hitachi_auth_method;
    "${volume_backend_name}/hitachi_auth_user":       value => $hitachi_auth_user;
    "${volume_backend_name}/hitachi_auth_password":       value => $hitachi_auth_password;
    "${volume_backend_name}/hitachi_debug_level":       value => $hitachi_debug_level;
  }
